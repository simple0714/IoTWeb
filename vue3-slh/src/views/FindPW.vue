...
const URL = "http://localhost:3001/apis/admin/findPw"
const id = ref('')
const username = ref('')
const email = ref('')
const phone = ref('')
...
const handleFindPw = async (e) => {
  ...
  // 유효성 검사
  if (!username.value && !email.value && !phone.value && !id.value) {
    error.value = '이름, 아이디, 이메일, 전화번호를 입력해주세요.'
    return
